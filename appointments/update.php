...
checks if the form has been submitted. If the form has been submitted, it updates the appointment in
the database. Finally, it displays a form to update the appointment data.
